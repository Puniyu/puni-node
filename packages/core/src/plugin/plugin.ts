import type { Message, MessageEventMap } from '@puniyu/types/event'
import type { PluginOptions } from '@puniyu/types/plugin/plugin'
import type { NodeElement } from '@puniyu/types/service/message/segment'
...
export class Plugin<T extends keyof MessageEventMap = keyof MessageEventMap> {
   ...
   */
  public async replyForward(element: NodeElement[]) {
