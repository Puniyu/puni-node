import type {
  ...
  SendMsgResults,
  UserInfo
} from '@puniyu/types/adapter/apiResponse'
import type { AdapterInfo } from '@puniyu/types/adapter/info'
import type { AccountInfo } from '@puniyu/types/event/account'
import type { Contact } from '@puniyu/types/event/contact'
import type { ForwardOptions, NodeElement, SendElement } from '@puniyu/types/service/message/segment'
import type { LoggerLevel } from '@punicore/logger'
