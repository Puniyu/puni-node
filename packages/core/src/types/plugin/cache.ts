import type { MessageEventMap } from '@puniyu/types/event'
import type { Accept, NoticeAndRequest } from '@puniyu/types/plugin/accept'
import type { PkgInfo } from '@puniyu/types/plugin/base'
