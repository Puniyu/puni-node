...
import { createRawMessage, makeMessage, segment } from '@puniyu/service/message'
import { AdapterProtocol, type AdapterType, type SendMsgResults } from '@puniyu/types/adapter'
import {
...
import { lockProp } from '@puniyu/utils/system/lock'
