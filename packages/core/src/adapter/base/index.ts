...
import {
  ...
  SendMsgResults,
  UserInfo
} from '@puniyu/types/adapter'
import { Contact } from '@puniyu/types/event/contact'
import { Elements, ForwardOptions, NodeElement } from '@puniyu/types/service/message/segment'
