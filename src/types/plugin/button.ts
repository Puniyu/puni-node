// TODO: 未完成 event 类型定义
import type { Event } from '@puni/types/event'
import type { PkgInfo, PluginFile } from '@puni/types/plugin/base'
import type { ButtonElement, KeyboardElement } from '@puni/types/service/message/segment'
