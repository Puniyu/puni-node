import type {
  ...
  SendMsgResults,
  UserInfo
} from '@puni/types/adapter/apiResponse'
import type { AdapterInfo } from '@puni/types/adapter/info'
import type { AccountInfo } from '@puni/types/event/account'
import type { Contact } from '@puni/types/event/contact'
import type { ForwardOptions, NodeElement, SendElement } from '@puni/types/service/message/segment'
