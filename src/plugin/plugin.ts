import type { Message, MessageEventMap } from '@puni/types/event'
import type { PluginOptions } from '@puni/types/plugin/plugin'
import type { NodeElement } from '@puni/types/service/message/segment'
