...
import { sep } from '@puni/utils/fs/file'
import { isWin } from '@puni/utils/system/system'
 ...
 * ```
 */
export const getRelPath = (filePath: string) =>
...
export const urlToPath = (url: string) => {
  ...
  return Array(upLevelsCount).fill('../').join('')
}
