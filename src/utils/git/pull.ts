import type { GitPullOptions, GitPullResult } from '@puni/types/utils/git/pull'
import { exists } from '@puni/utils/fs/fsPromise'
import { git, isGitRepo } from '@puni/utils/git/base'
import { getLocalCommitHash, getRemoteCommitHash } from '@puni/utils/git/commit'
/**
 * 构建pull返回值
 * @param status 是否成功
